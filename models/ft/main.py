...
X_train = pd.read_csv("FOFdata/Classification/AGORA/100/BC-III/csv/X_train_BC-III-100.csv")
X_val = pd.read_csv("FOFdata/Classification/AGORA/100/BC-III/csv/X_val_BC-III-100.csv")
X_test = pd.read_csv("FOFdata/Classification/AGORA/100/BC-III/csv/X_test_BC-III-100.csv")
y_train = pd.read_csv("FOFdata/Classification/AGORA/100/BC-III/csv/y_train_BC-III-100.csv")
y_val = pd.read_csv("FOFdata/Classification/AGORA/100/BC-III/csv/y_val_BC-III-100.csv")
y_test = pd.read_csv("FOFdata/Classification/AGORA/100/BC-III/csv/y_test_BC-III-100.csv")
...
final_metrics = calculate_and_save_metrics("test", save_path="FT-AG-100-BC-III_metrics.json")
